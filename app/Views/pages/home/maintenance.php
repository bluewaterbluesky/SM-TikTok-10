        <div class="d-flex justify-content-center mt-3 mb-3 p-5">
            <div class="row">
                <div class="text-center">
                    <img src="<?= base_url('images/v2/SM Supermalls - main logo - reverse.png') ?>">
                </div>
                ...
                <div class="justify-content-center mt-4 text-center">
                    <a href="#" class="btn btn-sm-primary col-sm-12 col-md-4 col-lg-4">Visit SM Supermalls for more details</a>
                </div>
                <p class="text-center text-white mt-4">
                    <strong>#SMSuperTikTok</strong>
                </p>
                <p class="text-center text-white mt-1">
                    <strong>
                        <small>
                            Per DTI Fair Trade Permit No. FTEB - xxxx, Series of 2021
                        </small>
                    </strong>
                </p>
                <p class="text-center mt-4">
                    <img src="<?= base_url('images/v3/sm-super-month.png') ?>" width="60px">
                </p>
            </div>
        </div>