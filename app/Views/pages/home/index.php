    <div class="container">
        ...
        <div class="row mt-3 mb-3">
            <div class="col-sm-12 col-md-6 col-lg-6 text-center d-none d-sm-block">
                <img src="<?= base_url('images/v4/banner kv.png') ?>" width="90%">
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="d-grid">
                    <a href="<?= base_url('signup') ?>" class="btn btn-sm-primary shadow">
    ...
    <div class="mt-3">
        <h1 id="mechanics" class="text-center text-yellow mt-5 mb-3">
            <strong>
                Mechanics
            </strong>
        </h1>
        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="how-to-join-tab" data-bs-toggle="tab" data-bs-target="#how-to-join" type="button" role="tab" aria-controls="how-to-join" aria-selected="true">How to join</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="guidelines-tab" data-bs-toggle="tab" data-bs-target="#guidelines" type="button" role="tab" aria-controls="guidelines" aria-selected="false">Guidelines</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="selection-process-tab" data-bs-toggle="tab" data-bs-target="#selection-process" type="button" role="tab" aria-controls="selection-process" aria-selected="false">Selection Process</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="guidelines" role="tabpanel" aria-labelledby="guidelines-tab">
                ...
                <p>
                    <ol class="text-white">
                        <li class="text-justify">
                            Contestants must incorporate the 2018 versions of the SM Jingle in their Tiktok entries. 
                            They may choose to use any of the versions (female, male, kids) and they may add effects or remix the chosen audio version. They can also add editing effects of their liking to the video (like text or filters).
                            <p class="m-4">
                                <a href="#" class="btn btn-sm-primary" role="button">Download SM Jingle 2018</a>        
                            </p>          
                        </li>
                        <li class="text-justify">
                            Contestants may choose to apply for the following categories:
                                <ul class="text-white">
                                    <li class="text-justify">Super Fam - Entry must show members of the family (parent/s, grandparent/s, and kids).</li>
                                    <li class="text-justify">Super PaweSM -  Entry must show any kind of pet allowed in SM.</li>
                                    <li class="text-justify">Super Youth - Entry can show solo / duo / squad contestants.</li>
                                </ul>
                        </li>
                        <li class="text-justify">
                            The runtime for the video should be a minimum of thirty (30) seconds and a maximum of one (1) minute.
                        </li>
                        <li class="text-justify">
                            Contestants may choose to shoot at their homes or in the malls. For those who opt to shoot at SM malls, the production should always follow safely protocols and are only allowed to 
                            shoot within the mall's designated TIKTOK safe zones (except for escalators, elevators, and restrooms). Failure to comply will automatically mean disqualification.
                        </li>
                        <li class="text-justify">
                            Profanities or vulgarity, content not safe for work (NSFW), potentially harmful action / activitities, and violence captured in the video will automatically mean disqualification.
                        </li>
                        <li class="text-justify">
                            The TikTok entry's privacy should be set to public untill the end of the contest.
                        </li>
                    </ol>
                </p>
            </div>
            <div class="tab-pane fade" id="selection-process" role="tabpanel" aria-labelledby="selection-process-tab">
                <p class="mt-5"><strong class="text-yellow display-7">SELECTION PROCESS (PRELIMINARY + REGIONAL)</strong></p>
                <p>
                    <ol class="text-white">
                        <li class="text-justify">
                ...
                <p><strong class="text-yellow display-7">RUBRICS FOR JUDGING</strong></p>
                <div style="overflow-x: auto;">
                    <table width="100%" class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center text-white">Criteria</th>
                                <th class="text-center text-white">Description</th>
                                <th class="text-center text-white">Percentage</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center text-white">Execution, dynamic editing, overall quality of production</td>
                            ...
                            <tr>
                                ...
                                <td class="text-center text-white">Entertainment value</td>
                                <td class="text-center text-white">1</td>
                            </tr>
                            <tr>
                                <td class="text-center text-white">
                                ...
                                <td class="text-center text-white">Charisma, confidence, charm</td>
                                <td class="text-center text-white">1</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <p><strong class="text-yellow display-7">FINALS ROUND</strong></p>
                <p>
                    <ol class="text-white">
                        <li>
            ...
            <div class="tab-pane fade" id="prizes" role="tabpanel" aria-labelledby="prizes-tab">
                <p class="mt-5"><strong class="text-yellow display-7">PRIZES</strong></p>
                <div style="overflow-x: auto;">
                    <table width="100%" class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center text-white">Award</th>
                                <th class="text-center text-white">Prizes</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center text-white">Total of Php 150,000 SM Gift Certificate (50k per winner/category) + sponsor's package</td>
                            </tr>
                            <tr>
                                <td class="text-center text-white">
                ...
                <p class="text-yellow"><b>CLAIMING OF PRIZES</b></p>
                <ol class="text-white">
                    <li>
                        To claim prizes, winners must email the following to (SM Supermalls email);
                        <ul class="text-white">
                            <li>
                                Photocopy of any valid ID with photo (e.g. Passport, Driver's License, SSS ID, Voter's ID, Company ID, Student ID, etc.)
                            </li>
                        </ul>
                    </li>
                    <li>
                        A representative from SM Supermalls will email the prize to the winner for their review. Once agreed, the winner will affix their e-signatures and send back the signed copy to SM Supermalls.
                    </li>
                    <li>
                        All items to be redeemed under this promotion shall be given tax-free.
                    </li>
                    <li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <h4 class="text-blue mt-3 mb-4"><strong>Sign In</strong></h4>
                    <form id="signin-form">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?= base_url('signup') ?>" class="btn btn-sm-outline-primary">Don't have an account? Sign Up!</a>
                        </div>
                    </form>
                </div>
            </div>
